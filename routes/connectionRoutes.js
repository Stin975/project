...
const {validateId, validateRsvp, validateResults, validateStory} = require('../middlewares/validator')
...
router.post('/', isLoggedIn, validateStory , validateResults,  controller.create);

router.get('/:id/edit', isLoggedIn, validateId, isAuthor, controller.edit);

router.put('/:id', isLoggedIn, validateId, isAuthor, validateStory , validateResults, controller.update);
